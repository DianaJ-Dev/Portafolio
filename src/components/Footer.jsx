        ...
        <div className="row p-4 b-2 ">
            ...
            <div className="col-xs-12 col-md-6 col-lg-3">
                ...
                <a href="https://github.com/DianaJ-Dev" target="_blank" rel="noopener noreferrer">
                    <svg xmlns="http://www.w3.org/2000/svg" width="30" height="30" fill="currentColor" className="bi-github" viewBox="0 0 16 16">
                ...
                <CopyToClipboard text='juliethdiana123@gmail.com' onCopy={() => setcopied(true)}>
                  <svg xmlns="http://www.w3.org/2000/svg" width="15" height="15" fill="currentColor" className="bi-footer bi-copy mr-2 mx-4 cursor-pointer" viewBox="0 0 16 16 " >
